...
public class Main__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<CommandLineRunner> getRunnerInstanceSupplier() {
    return BeanInstanceSupplier.<CommandLineRunner>forFactoryMethod(Main$$SpringCGLIB$$0.class, "runner", CustomerRepository.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("main", Main.class).runner(args.get(0)));
  }
  ...
  public static BeanDefinition getRunnerBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("main");
